 ...
 * 
 */
package es.caib.ripea.api.interna.helper;
...
public class ConversioTipusHelper {
	...
	public static class CustomJavassistCompilerStrategy extends JavassistCompilerStrategy {
		public CustomJavassistCompilerStrategy() {
			super();
		}
	}
