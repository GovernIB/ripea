...
<body>
	...
	<script id="botonsTemplate" type="text/x-jsrender">
		<div class="btn-group pull-right">
			...
			<button type="button" id="seleccioNone" title="<spring:message code="expedient.list.user.seleccio.cap"/>" class="btn btn-default"><span class="fa fa-square-o"></span></a>
				<button type="button" class="btn btn-default" href="./firmasimpleweb/firmaSimpleWeb" data-toggle="modal" data-refresh-pagina="false">
					<span id="seleccioCount" class="badge">${fn:length(seleccio)}</span> <spring:message code="accio.massiva.boto.firmasimpleweb"/>
				</button>
		</div>
	</script>
	...
	<table id="taulaDades" 
		...
		data-url="<c:url value="/massiu/firmasimpleweb/datatable"/>"
			...
			<tr>
				...
				<th data-col-name="id" data-template="#cellAccionsTemplate" data-orderable="false" width="1%">
					<script id="cellAccionsTemplate" type="text/x-jsrender">
						<a href="<c:url value="/document/{{:id}}/firmaSimpleWeb?massiu=true"/>" class="btn btn-default" data-toggle="modal" data-refresh-pagina="true"><span class="fa fa-edit"></span>&nbsp;<spring:message code="accio.massiva.boto.firmasimpleweb"/></a>	
					</script>
				</th>					
			</tr>
		</thead>
