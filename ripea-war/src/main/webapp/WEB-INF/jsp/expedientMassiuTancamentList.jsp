...
<html>
<head>
	<title><spring:message code="accio.massiva.titol.tancament"/></title>
...
<body>
	...
	<script id="botonsTemplate" type="text/x-jsrender">
		<div class="btn-group pull-right">
			...
			<button type="button" class="btn btn-default" href="./tancament/tancar" data-toggle="modal" data-refresh-pagina="true">
				<span id="seleccioCount" class="badge">${fn:length(seleccio)}</span> <spring:message code="accio.massiva.boto.tancar"/>
			</button>
		</div>
	</script>
