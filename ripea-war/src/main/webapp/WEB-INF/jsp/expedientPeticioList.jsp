						...
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								{{if estatView == 'PENDENT'}}
									<li><a href="<c:url value="/expedientPeticio/acceptar/{{:id}}"/>" data-toggle="modal" data-maximized="true" data-refresh-pagina="true"><span class="fa fa-check"></span>&nbsp;<spring:message code="comu.boto.acceptar"/></a></li>
