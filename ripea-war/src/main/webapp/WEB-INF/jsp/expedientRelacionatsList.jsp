...
<c:set var="titol"><spring:message code="contingut.expedient.relacionats.list.titol"/></c:set>
<html>
<head>
	<title>${titol}</title>
			...
			<tr>
				...
				<th data-col-name="id" data-template="#cellAccionsTemplate" data-orderable="false" width="10%">
					<script id="cellAccionsTemplate" type="text/x-jsrender">
						<a href="importarExpedient/{{:id}}" class="btn btn-success"><span class="fa fa-arrow-circle-down"></span>&nbsp;&nbsp;<spring:message code="contingut.expedient.relacionats.list.boto.importar"/></a>
					</script>
				</th>					
