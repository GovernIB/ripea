...
<%--		<c:if test="${documentCommand.documentTipus != 'IMPORTAT' && isPermesModificarCustodiatsVar}">--%>
		...
		<div id="modal-botons" class="well">
			<button type="submit" class="crearDocumentBtnSubmit btn btn-success"><span class="fa fa-save"></span>
				<c:choose>
					<c:when test="${empty documentCommand.id}"><spring:message code="comu.boto.crear"/></c:when>
