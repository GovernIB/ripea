 ...
 *
 * El evict és pla (no recalcula ni notifica per SSE): la validesa es recalcula peresosament quan algú obre o
 * llista el node. El cridador l'invoca després del commit de la transacció (veure TransactionAfterCommitUtils)
 * perquè el recàlcul posterior vegi ja el canvi persistit i no torni a cachejar dades antigues.
 */
@Component
