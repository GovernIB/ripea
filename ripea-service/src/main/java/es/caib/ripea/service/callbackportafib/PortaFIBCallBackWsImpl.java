 ...
 * 
 */
package es.caib.ripea.service.callbackportafib;
...
public class PortaFIBCallBackWsImpl implements PortaFIBCallBackWs {
	...
	public void event(PortaFIBEvent event) throws CallBackException {
		...
		accioParams.put("portafirmesId", Long.valueOf(documentId).toString());
		accioParams.put("estat", Integer.valueOf(estat).toString());
