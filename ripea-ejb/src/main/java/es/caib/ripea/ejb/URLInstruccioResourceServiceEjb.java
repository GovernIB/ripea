...
@Stateless
@RolesAllowed("**")
public class URLInstruccioResourceServiceEjb extends AbstractServiceEjb<URLInstruccioResourceService> implements URLInstruccioResourceService {

	@Delegate private URLInstruccioResourceService delegateService;

	protected void setDelegateService(URLInstruccioResourceService delegateService) {
