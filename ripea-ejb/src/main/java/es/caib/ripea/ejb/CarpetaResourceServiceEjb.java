...
@Stateless
@RolesAllowed("**")
public class CarpetaResourceServiceEjb extends AbstractServiceEjb<CarpetaResourceService> implements CarpetaResourceService {

	@Delegate private CarpetaResourceService delegateService;
	
	protected void setDelegateService(CarpetaResourceService delegateService) {
