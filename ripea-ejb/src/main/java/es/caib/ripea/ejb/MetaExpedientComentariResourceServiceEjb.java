...
@Stateless
@RolesAllowed("**")
public class MetaExpedientComentariResourceServiceEjb extends AbstractServiceEjb<MetaExpedientComentariResourceService> implements MetaExpedientComentariResourceService {

	@Delegate private MetaExpedientComentariResourceService delegateService;

	protected void setDelegateService(MetaExpedientComentariResourceService delegateService) {
