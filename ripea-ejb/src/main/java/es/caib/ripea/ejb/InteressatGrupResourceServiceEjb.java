...
@Stateless
@RolesAllowed("**")
public class InteressatGrupResourceServiceEjb extends AbstractServiceEjb<InteressatGrupResourceService> implements InteressatGrupResourceService {
	
	@Delegate private InteressatGrupResourceService delegateService;
	
	protected void setDelegateService(InteressatGrupResourceService delegateService) {
