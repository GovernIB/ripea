...
public class RegistreAnnexResourceServiceEjb extends AbstractServiceEjb<RegistreAnnexResourceService> implements RegistreAnnexResourceService {
	...
	@Override
	@RolesAllowed("**")
	public RegistreAnnexResource newResourceInstance() {
		return delegateService.newResourceInstance();
	}

	@Override
	@RolesAllowed("**")
	public RegistreAnnexResource create(RegistreAnnexResource resource, Map<String, AnswerValue> answers)
	...
	@Override
	@RolesAllowed("**")
	public RegistreAnnexResource update(Long id, RegistreAnnexResource resource, Map<String, AnswerValue> answers)
	...
	@Override
	@RolesAllowed("**")
	public Map<String, Object> onChange(RegistreAnnexResource previous, String fieldName, Object fieldValue,
