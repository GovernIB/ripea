...
@Stateless
@RolesAllowed("**")
public class FluxFirmaUsuariResourceServiceEjb extends AbstractServiceEjb<FluxFirmaUsuariResourceService> implements FluxFirmaUsuariResourceService {

	@Delegate private FluxFirmaUsuariResourceService delegateService;

	protected void setDelegateService(FluxFirmaUsuariResourceService delegateService) {
