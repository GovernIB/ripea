...
public class ExpedientSeguidorResourceServiceEjb extends AbstractServiceEjb<ExpedientSeguidorResourceService> implements ExpedientSeguidorResourceService {
	...
	@Override
	@RolesAllowed("**")
	public ExpedientSeguidorResource newResourceInstance() {
		return delegateService.newResourceInstance();
	}

	@Override
	@RolesAllowed("**")
	public ExpedientSeguidorResource create(ExpedientSeguidorResource resource, Map<String, AnswerValue> answers)
	...
	@Override
	@RolesAllowed("**")
	public ExpedientSeguidorResource update(ExpedientSeguidorId id, ExpedientSeguidorResource resource,
	...
	@Override
	@RolesAllowed("**")
	public void delete(ExpedientSeguidorId id, Map<String, AnswerValue> answers)
	...
	@Override
	@RolesAllowed("**")
	public Map<String, Object> onChange(ExpedientSeguidorResource previous, String fieldName, Object fieldValue,
	...
	@Override
	@RolesAllowed("**")
	public <P extends Serializable> Serializable artifactActionExec(ExpedientSeguidorId id, String code, P params)
	...
	@Override
	@RolesAllowed("**")
	public ExpedientSeguidorResource getOne(ExpedientSeguidorId id, String[] perspectives)
	...
	@Override
	@RolesAllowed("**")
	public Page<ExpedientSeguidorResource> findPage(String quickFilter, String filter, String[] namedQueries,
	...
	@Override
	@RolesAllowed("**")
	public DownloadableFile fieldDownload(ExpedientSeguidorId id, String fieldName, OutputStream out)
			throws ResourceNotFoundException, ResourceFieldNotFoundException, FieldArtifactNotFoundException,
			IOException {
	...
	@Override
	@RolesAllowed("**")
	public <P extends Serializable> List<?> artifactReportGenerateData(ExpedientSeguidorId id, String code, P params)
