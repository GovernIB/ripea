...
@Stateless
@RolesAllowed("**")
public class ExcepcioLogServiceEjb extends AbstractServiceEjb<ExcepcioLogService> implements ExcepcioLogService {

	@Delegate private ExcepcioLogService delegateService;
	
	protected void setDelegateService(ExcepcioLogService delegateService) {
