...
@Stateless
@RolesAllowed("**")
public class AclSidResourceServiceEjb extends AbstractServiceEjb<AclSidResourceService> implements AclSidResourceService {

	@Delegate private AclSidResourceService delegateService;
	
	protected void setDelegateService(AclSidResourceService delegateService) {
