...
@Stateless
@RolesAllowed("**")
public class IntegracioResourceServiceEjb extends AbstractServiceEjb<IntegracioResourceService> implements IntegracioResourceService {

	@Delegate private IntegracioResourceService delegateService;
	
	protected void setDelegateService(IntegracioResourceService delegateService) {
