...
@Stateless
@RolesAllowed("**")
public class MetaDocumentFluxPortafibResourceServiceEjb extends AbstractServiceEjb<MetaDocumentFluxPortafibResourceService> implements MetaDocumentFluxPortafibResourceService {

	@Delegate private MetaDocumentFluxPortafibResourceService delegateService;
	
	protected void setDelegateService(MetaDocumentFluxPortafibResourceService delegateService) {
		this.delegateService = delegateService;
	}
	
	@Override
	public MetaDocumentFluxPortafibResource newResourceInstance() {
		return delegateService.newResourceInstance();
	}

	@Override
	public MetaDocumentFluxPortafibResource create(MetaDocumentFluxPortafibResource resource,
	...
	@Override
	public MetaDocumentFluxPortafibResource update(Long id, MetaDocumentFluxPortafibResource resource,
			Map<String, AnswerValue> answers)
	...
	@Override
	public Map<String, Object> onChange(Long id, MetaDocumentFluxPortafibResource previous, String fieldName,
	...
	@Override
	public MetaDocumentFluxPortafibResource getOne(Long id, String[] perspectives) throws ResourceNotFoundException {
		return delegateService.getOne(id, perspectives);
	}

	@Override
	public Page<MetaDocumentFluxPortafibResource> findPage(String quickFilter, String filter, String[] namedQueries,
