...
@Stateless
@RolesAllowed("**")
public class DocumentViafirmaResourceServiceEjb extends AbstractServiceEjb<DocumentViafirmaResourceService> implements DocumentViafirmaResourceService {

	@Delegate private DocumentViafirmaResourceService delegateService;
	...
	@Override
	protected void setDelegateService(DocumentViafirmaResourceService delegateService) {
