...
@Stateless
@RolesAllowed("**")
public class ConsultaPinbalResourceServiceEjb extends AbstractServiceEjb<ConsultaPinbalResourceService> implements ConsultaPinbalResourceService {

	@Delegate private ConsultaPinbalResourceService delegateService;
	
	protected void setDelegateService(ConsultaPinbalResourceService delegateService) {
