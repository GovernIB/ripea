...
@Stateless
@RolesAllowed("**")
public class TipusDocumentalResourceServiceEjb extends AbstractServiceEjb<TipusDocumentalResourceService> implements TipusDocumentalResourceService {

	@Delegate private TipusDocumentalResourceService delegateService;
	
	protected void setDelegateService(TipusDocumentalResourceService delegateService) {
