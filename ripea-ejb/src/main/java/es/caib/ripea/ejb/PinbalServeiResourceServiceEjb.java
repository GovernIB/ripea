...
@Stateless
@RolesAllowed("**")
public class PinbalServeiResourceServiceEjb extends AbstractServiceEjb<PinbalServeiResourceService> implements PinbalServeiResourceService {

	@Delegate private PinbalServeiResourceService delegateService;
	
	protected void setDelegateService(PinbalServeiResourceService delegateService) {
