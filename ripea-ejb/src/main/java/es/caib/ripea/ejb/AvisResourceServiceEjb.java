...
public class AvisResourceServiceEjb extends AbstractServiceEjb<AvisResourceService> implements AvisResourceService {
	...
	@Delegate private AvisResourceService delegateService;
	...
	@Override
	public <P extends Serializable> Serializable artifactActionExec(Long id, String code, P params) throws ArtifactNotFoundException, ActionExecutionException {
