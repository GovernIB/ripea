...
@Stateless
@RolesAllowed("**")
public class MetaExpedientTascaValidacioResourceServiceEjb extends AbstractServiceEjb<MetaExpedientTascaValidacioResourceService> implements MetaExpedientTascaValidacioResourceService {

	@Delegate private MetaExpedientTascaValidacioResourceService delegateService;

	protected void setDelegateService(MetaExpedientTascaValidacioResourceService delegateService) {
		this.delegateService = delegateService;
	}
	
	@Override
	public MetaExpedientTascaValidacioResource newResourceInstance() {
		return delegateService.newResourceInstance();
	}

	@Override
	public MetaExpedientTascaValidacioResource create(MetaExpedientTascaValidacioResource resource,
	...
	@Override
	public MetaExpedientTascaValidacioResource update(Long id, MetaExpedientTascaValidacioResource resource,
			Map<String, AnswerValue> answers)
	...
	@Override
	public Map<String, Object> onChange(Long id, MetaExpedientTascaValidacioResource previous, String fieldName,
			Object fieldValue, Map<String, AnswerValue> answers)
			throws ResourceFieldNotFoundException, AnswerRequiredException {
		return delegateService.onChange(id, previous, fieldName, fieldValue, answers);
	}
	...
	public List<FieldOption> fieldEnumOptions(String fieldName, Map<String, String[]> requestParameterMap) {
		return delegateService.fieldEnumOptions(fieldName, requestParameterMap);
	}

	@Override
	public MetaExpedientTascaValidacioResource getOne(Long id, String[] perspectives) throws ResourceNotFoundException {
		return delegateService.getOne(id, perspectives);
	}

	@Override
	public Page<MetaExpedientTascaValidacioResource> findPage(String quickFilter, String filter, String[] namedQueries,
	...
	public DownloadableFile export(String quickFilter, String filter, String[] namedQueries, String[] perspectives,
			Pageable pageable, ExportField[] fields, ReportFileType fileType, OutputStream out) {
		return delegateService.export(quickFilter, filter, namedQueries, perspectives, pageable, fields, fileType, out);
	}
	...
	@Override
	public List<FieldOption> artifactFieldEnumOptions(ResourceArtifactType type, String code, String fieldName,
			Map<String, String[]> requestParameterMap) {
		return delegateService.artifactFieldEnumOptions(type, code, fieldName, requestParameterMap);
	}
	...
	@Override
	public DownloadableFile artifactReportGenerateFile(String code, List<?> data, ReportFileType fileType,
			OutputStream out) throws ArtifactNotFoundException, ReportGenerationException {
		return delegateService.artifactReportGenerateFile(code, data, fileType, out);
	}
}