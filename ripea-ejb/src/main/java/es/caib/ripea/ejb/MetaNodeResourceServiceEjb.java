...
@Stateless
@RolesAllowed("**")
public class MetaNodeResourceServiceEjb extends AbstractServiceEjb<MetaNodeResourceService> implements MetaNodeResourceService {

	@Delegate private MetaNodeResourceService delegateService;
	
	protected void setDelegateService(MetaNodeResourceService delegateService) {
		this.delegateService = delegateService;
	}
	
	@Override
	public MetaNodeResource newResourceInstance() {
		return delegateService.newResourceInstance();
	}

	@Override
	public MetaNodeResource create(MetaNodeResource resource, Map<String, AnswerValue> answers)
	...
	@Override
	public MetaNodeResource update(Long id, MetaNodeResource resource, Map<String, AnswerValue> answers)
	...
	@Override
	public Map<String, Object> onChange(Long id, MetaNodeResource previous, String fieldName, Object fieldValue,
	...
	@Override
	public MetaNodeResource getOne(Long id, String[] perspectives) throws ResourceNotFoundException {
		return delegateService.getOne(id, perspectives);
	}

	@Override
	public Page<MetaNodeResource> findPage(String quickFilter, String filter, String[] namedQueries,
