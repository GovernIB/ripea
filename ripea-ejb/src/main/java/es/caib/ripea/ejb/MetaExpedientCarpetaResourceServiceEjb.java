...
@Stateless
@RolesAllowed("**")
public class MetaExpedientCarpetaResourceServiceEjb extends AbstractServiceEjb<MetaExpedientCarpetaResourceService> implements MetaExpedientCarpetaResourceService {

	@Delegate private MetaExpedientCarpetaResourceService delegateService;

	protected void setDelegateService(MetaExpedientCarpetaResourceService delegateService) {
		this.delegateService = delegateService;
	}
	
	@Override
	public MetaExpedientCarpetaResource newResourceInstance() {
		return delegateService.newResourceInstance();
	}

	@Override
	public MetaExpedientCarpetaResource create(MetaExpedientCarpetaResource resource, Map<String, AnswerValue> answers)
	...
	@Override
	public MetaExpedientCarpetaResource update(Long id, MetaExpedientCarpetaResource resource,
	...
	@Override
	public Map<String, Object> onChange(Long id, MetaExpedientCarpetaResource previous, String fieldName,
	...
	@Override
	public MetaExpedientCarpetaResource getOne(Long id, String[] perspectives) throws ResourceNotFoundException {
		return delegateService.getOne(id, perspectives);
	}

	@Override
	public Page<MetaExpedientCarpetaResource> findPage(String quickFilter, String filter, String[] namedQueries,
