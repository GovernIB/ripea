...
--  	ORGAN_ID                 NUMBER(19),
	...
	N_EXPED_TANCATS_ACUM     NUMBER(19)	    NOT NULL,
	N_EXPED_AMB_ALERTES      NUMBER(19)	    NOT NULL,
	N_EXPED_ERORS_VALID      NUMBER(19)	    NOT NULL,
	N_DOCS_PENDENTS_SIGN     NUMBER(19)     NOT NULL,
	N_DOCS_SIGN              NUMBER(19)		NOT NULL,
	N_DOCS_PENDENTS_NOTIF    NUMBER(19)		NOT NULL,
	N_DOCS_NOTIF             NUMBER(19)	    NOT NULL,
...
ALTER TABLE IPA_HIST_EXPEDIENT ADD (
  CONSTRAINT IPA_HIST_EXPEDIENT_OID_PK PRIMARY KEY (ID),
  CONSTRAINT IPA_HIST_EXPEDIENT_UK UNIQUE (METAEXPEDIENT_ID, TIPUS, DATA),
--  CONSTRAINT IPA_HIST_EXPEDIENT_ENTITAT_FK FOREIGN KEY (ENTITAT_ID) REFERENCES IPA_ENTITAT (ID),
--  CONSTRAINT IPA_HIST_EXPEDIENT_ORGAN_FK FOREIGN KEY (ORGAN_ID) REFERENCES IPA_ORGAN_GESTOR (ID),
  CONSTRAINT IPA_HIST_EXPEDIENT_METAEXT_FK FOREIGN KEY (METAEXPEDIENT_ID) REFERENCES IPA_METAEXPEDIENT (ID)
...
ALTER TABLE IPA_HIST_EXP_USUARI ADD (
  CONSTRAINT IPA_HIST_EXP_USUARI_OID_PK PRIMARY KEY (ID),
  CONSTRAINT IPA_HIST_EXP_USUARI_UK UNIQUE (USUARI_CODI, METAEXPEDIENT_ID, TIPUS, DATA),
--  CONSTRAINT IPA_HIST_EXP_USUARI_ENTITAT_FK FOREIGN KEY (ENTITAT_ID) REFERENCES IPA_ENTITAT (ID),
--  CONSTRAINT IPA_HIST_EXP_USUARI_ORGAN_FK FOREIGN KEY (ORGAN_ID) REFERENCES IPA_ORGAN_GESTOR (ID),
  CONSTRAINT IPA_HIST_EXP_USUARI_METAEXT_FK FOREIGN KEY (METAEXPEDIENT_ID) REFERENCES IPA_METAEXPEDIENT (ID)
);
...
ALTER TABLE IPA_HIST_EXP_USUARI ADD (
  CONSTRAINT IPA_HIST_EXP_INTERESSAT_USUARI_OID_PK PRIMARY KEY (ID),
  CONSTRAINT IPA_HIST_EXP_INTERESSAT_UK UNIQUE (INTERESSAT_ID, METAEXPEDIENT_ID, TIPUS, DATA),
  CONSTRAINT IPA_HIST_EXP_INTERESSAT_INTERESSAT_FK FOREIGN KEY (INTERESSAT_ID) REFERENCES IPA_INTERESSAT (ID),
--  CONSTRAINT IPA_HIST_EXP_INTERESSAT_ENTITAT_FK FOREIGN KEY (ENTITAT_ID) REFERENCES IPA_ENTITAT (ID),
--  CONSTRAINT IIPA_HIST_EXP_INTERESSAT_ORGAN_FK FOREIGN KEY (ORGAN_ID) REFERENCES IPA_ORGAN_GESTOR (ID),
  CONSTRAINT IPA_HIST_EXP_INTERESSAT_FK FOREIGN KEY (METAEXPEDIENT_ID) REFERENCES IPA_METAEXPEDIENT (ID)
);
