...
Insert into IPA_CONFIG (KEY,VALUE,DESCRIPTION,GROUP_CODE,POSITION,JBOSS_PROPERTY,TYPE_CODE) values ('es.caib.ripea.segonpla.arxiu.maxTempsExec','10','Maxim temps en minut que pot tardar el procés de  generar l''arxiu zip que conté els documents dels expedients seleccionats.','SCHEDULLED',4,0,'INT');
...
INSERT INTO ipa_config (key, description, group_code, position, jboss_property, type_code, configurable, configurable_organ) VALUES ('es.caib.ripea.plugin.summarize.class', 'Classe del plugin', 'SUMMARIZE', '0', '1', 'SUMMARIZE_CLASS', '1', '1');
...
INSERT INTO ipa_config (key, description, group_code, position, jboss_property, type_code, configurable, configurable_organ) VALUES ('es.caib.ripea.plugin.summarize.gpt.apiKey', 'ApiKey d''accés al servei de resum GPT', 'SUMMARIZE', '4', '1', 'TEXT', '1', '1');
INSERT INTO ipa_config (key, description, group_code, position, jboss_property, type_code, configurable, configurable_organ) VALUES ('es.caib.ripea.plugin.summarize.model', 'Model de IA a utilitzar si escau.', 'SUMMARIZE', '0', '1', 'TEXT', '1', '1');
INSERT INTO ipa_config (key, description, group_code, position, jboss_property, type_code, configurable, configurable_organ) VALUES ('es.caib.ripea.plugin.summarize.model.maxTokens', 'Maxim de tokens (tipicament paraules, pero no sempre) que soporta el model en la peticio i resposta combinats.', 'SUMMARIZE', '0', '1', 'INT', '1', '1');
