...
V_CREATEDBY_CODI VARCHAR2(64) := 'admin'; 
BEGIN
    ...
    FROM   dual;
	    ...
	    VALUES (V_METANODE_ID,'OTROS','Otros',null,'DOCUMENT',V_ENTITAT_ID,'1','16',V_CREATEDBY_CODI,to_timestamp(sysdate,'DD/MM/RR HH24:MI:SSXFF'),'admin',to_timestamp(sysdate,'DD/MM/RR HH24:MI:SSXFF'));
	    -- Create metadocument 
    ...
    FROM   dual;
	   	...
	   	-- Create metanode and return id
		INSERT INTO GEST.IPA_METANODE (ID,CODI,NOM,DESCRIPCIO,TIPUS,ENTITAT_ID,ACTIU,VERSION,CREATEDBY_CODI,CREATEDDATE,LASTMODIFIEDBY_CODI,LASTMODIFIEDDATE) 
	    VALUES (V_METANODE_ID,'ACUSE_RECIBO_NOTIFICACION','Acuse recibo notificación',null,'DOCUMENT',V_ENTITAT_ID,'1','16',V_CREATEDBY_CODI,to_timestamp(sysdate,'DD/MM/RR HH24:MI:SSXFF'),'admin',to_timestamp(sysdate,'DD/MM/RR HH24:MI:SSXFF'));
 		-- Create metadocument 
	   	INSERT INTO IPA_METADOCUMENT (ID,MULTIPLICITAT,FIRMA_PFIRMA,PORTAFIRMES_DOCTIP,PORTAFIRMES_FLUXID,PORTAFIRMES_RESPONS,PORTAFIRMES_FLUXTIP,PORTAFIRMES_CUSTIP,FIRMA_PASSARELA,PASSARELA_CUSTIP,PLANTILLA_NOM,PLANTILLA_CONTENT_TYPE,META_EXPEDIENT_ID,NTI_ORIGEN,NTI_ESTELA,NTI_TIPDOC,FIRMA_BIOMETRICA,BIOMETRICA_LECTURA,META_DOCUMENT_TIPUS_GEN) 
    ...
    FROM   dual;
   		...
   		-- Create metanode and return id
		INSERT INTO GEST.IPA_METANODE (ID,CODI,NOM,DESCRIPCIO,TIPUS,ENTITAT_ID,ACTIU,VERSION,CREATEDBY_CODI,CREATEDDATE,LASTMODIFIEDBY_CODI,LASTMODIFIEDDATE) 
	    VALUES (V_METANODE_ID,'NOTIFICACION','Notificación',null,'DOCUMENT',V_ENTITAT_ID,'1','16',V_CREATEDBY_CODI,to_timestamp(sysdate,'DD/MM/RR HH24:MI:SSXFF'),'admin',to_timestamp(sysdate,'DD/MM/RR HH24:MI:SSXFF'));
    ...
    FROM   dual;
	   	...
	   	-- Create metanode and return id
		INSERT INTO GEST.IPA_METANODE (ID,CODI,NOM,DESCRIPCIO,TIPUS,ENTITAT_ID,ACTIU,VERSION,CREATEDBY_CODI,CREATEDDATE,LASTMODIFIEDBY_CODI,LASTMODIFIEDDATE) 
	    VALUES (V_METANODE_ID,'JUSTIFICANTE_REGISTRO','Justificante registro',null,'DOCUMENT',V_ENTITAT_ID,'1','16',V_CREATEDBY_CODI,to_timestamp(sysdate,'DD/MM/RR HH24:MI:SSXFF'),'admin',to_timestamp(sysdate,'DD/MM/RR HH24:MI:SSXFF'));
