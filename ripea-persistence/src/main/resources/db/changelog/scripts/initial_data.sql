...
Insert into IPA_CONFIG_GROUP (CODE,PARENT_CODE,POSITION,DESCRIPTION) values ('DADES_EXT','PLUGINS','6','Configuració del plugin de dades externes');
...
Insert into IPA_CONFIG_GROUP (CODE,PARENT_CODE,POSITION,DESCRIPTION) values ('DISTRIBUCIO_REGLA','PLUGINS','11','Plugin de creació de regles en DISTRIBUCIO');
...
Insert into IPA_CONFIG_GROUP (CODE,PARENT_CODE,POSITION,DESCRIPTION) values ('VALIDATE_SIGNATURE','FIRMA','5','Configuració del plugin de validació de firmes');
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','SCHEDULLED','es.caib.ripea.segonpla.arxiu.maxMb','100','Màxim tamany en Mb que pot ocupar l''arxiu zip que conté els documents dels expedients seleccionats.','3','INT','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','SCHEDULLED','es.caib.ripea.segonpla.arxiu.maxTempsExec','10','Màxim temps en minuts que pot tardar el procés de generar l''arxiu zip que conté els documents dels expedients seleccionats.','4','INT','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.document.nou.escanejar.actiu','false','Activar l''escaneig en document nou','13','BOOL','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','SCHEDULLED','es.caib.ripea.tasca.consulta.anotacio.temps.espera.execucio','30000','Interval de temps (ms) en què s''executa la tasca periòdica de consultar i guardar anotacions per peticions pendents de creació dels expedients','0','INT','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','SCHEDULLED','es.caib.ripea.segonpla.massives.periode.comprovacio','30000','Interval de temps (ms) en què s''executa la tasca periòdica que comprova les execucions massives.','0','INT','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','ALTRES','es.caib.ripea.duracio.tasca','10','Duració per defecte d''una tasca, sempre especificada en dies.','0','INT','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','SCHEDULLED','es.caib.ripea.dominis.cache.execucio','3600000','Interval de temps (ms) en què buidar la cache de dominis','0','INT','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','ALTRES','es.caib.ripea.tasca.preavisDataLimitEnDies','3','Nombre de dies límit en què s''ha d''enviar el preavís','0','INT','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','SCHEDULLED','es.caib.ripea.segonpla.reintentar.anotacions.pendents.enviar.distribucio','600000','Interval de temps (ms) en què s''executa la tasca periòdica de reintentar canviar l''estat de les anotacions a Distribució','0','INT','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','SCHEDULLED','es.caib.ripea.segonpla.email.enviament.procediment.comentari.cron','0 0 * * * *','Expressió cron per indicar quan executar la tasca periòdica per enviar els correus electrònics avisant que s''ha afegit un comentari al procediment','8','CRON','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','SCHEDULLED','es.caib.ripea.segonpla.guardar.arxiu.continguts.pendents','600000','Interval de temps (ms) en què s''executa la tasca periòdica de guardar documents i expedients pendents a l''arxiu','1','INT','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','SCHEDULLED','es.caib.ripea.segonpla.guardar.arxiu.interessats','600000','Interval de temps (ms) en què s''executa la tasca periòdica de guardar interessats pendents a l''arxiu','2','INT','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','SCHEDULLED','es.caib.ripea.procediment.actualitzar.cron','0 15 * * * *','Cron per a l''actualització de procediments','6','TEXT','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.expedient.tancament.logic.cron','0 0 20 * * *','Consulta diària dels expedients pendents de tancar i si ha arribat la data programada','41','TEXT','0','0','0','1','0');

Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('1','PINBAL','es.caib.ripea.pinbal.base.url','https://proves.caib.es/pinbalapi','Url del plugin','1','TEXT','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','PINBAL','es.caib.ripea.pinbal.basic.auth','true','Indica si l''autenticació és de tipus bàsic','0','BOOL','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('1','PINBAL','es.caib.ripea.pinbal.password',null,'Contrasenya del plugin','3','PASSWORD','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('1','ORGANISMES','es.caib.ripea.plugin.unitats.organitzatives.dir3.service.password',null,'Contrasenya de l''usuari per a accedir a DIR3','3','TEXT','0','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('1','NOTIB','es.caib.ripea.plugin.notificacio.password','ripea_notib','Contrasenya del plugin','0','PASSWORD','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('1','FIRMA_SERVIDOR','es.caib.ripea.plugin.firmaservidor.portafib.auth.password','ripea_portafib_pre','Contrasenya per accedir al Portafirmes','3','PASSWORD','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('1','PORTAFIRMES','es.caib.ripea.plugin.portafirmes.firmasimpleasync.password','ripea_portafib_dev','Contrasenya de l''API de firma simple asíncrona','3','PASSWORD','1','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','PORTAFIRMES','es.caib.ripea.plugin.portafirmes.carrer.mostrar.persona','false','Mostrar la persona relacionada amb el càrrec','11','BOOL','1','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','PORTAFIRMES','es.caib.ripea.plugin.portafirmes.portafib.enviar.url.expedient','false','Enviar URL de l''expedient en enviar a firmar','12','BOOL','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('1','PORTAFIRMES','es.caib.ripea.plugin.portafirmes.firmasimpleflux.password','ripea_portafib_dev','Contrasenya de l''API de firma simple per flux','6','PASSWORD','1','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('1','PORTAFIRMES','es.caib.ripea.plugin.portafirmes.usuarientitatws.password','ripea_portafib_dev','Contrasenya del webservice UsuariEntitat','23','PASSWORD','1','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','PORTAFIRMES','es.caib.ripea.portafirmes.avis.firma.parcial','false','Mostrar opció per indicar si rebre avisos de firmes parcials','8','BOOL','0','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','PORTAFIRMES','es.caib.ripea.portafirmes.firma.parcial','false','Mostrar opció per indicar si la firma de Portafib és parcial','9','BOOL','0','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','PORTAFIRMES','es.caib.ripea.plugin.portafirmes.flux.filtrar.usuari.descripcio','false','Indica si filtrar els fluxos per usuari actual utilitzant el camp descripció','10','BOOL','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','PORTAFIRMES','es.caib.ripea.activar.tipus.document.portafirmes','false','Activar l''ús del tipus de document de portafirmes','13','BOOL','1','0','0','1','0');
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('1','FIRMA_SIMPLE_WEB','es.caib.ripea.plugin.firmasimpleweb.password','ripea_portafib_dev','Contrasenya del plugin','4','PASSWORD','1','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','FIRMA_SIMPLE_WEB','es.caib.ripea.plugin.firmasimpleweb.location',null,'Localització on es realitza la firma','6','TEXT','0','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('1','ARXIU','es.caib.ripea.plugin.arxiu.caib.conversio.imprimible.contrasenya','concsv_ripea','Contrasenya per a generar imprimible','7','PASSWORD','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('1','DISTRIBUCIO_REGLA','es.caib.ripea.distribucio.regla.ws.password',null,'Contrasenya del plugin','3','PASSWORD','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','DISTRIBUCIO_REGLA','es.caib.ripea.distribucio.regla.ws.codi.backoffice',null,'Codi de backoffice','4','TEXT','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','DISTRIBUCIO_REGLA','es.caib.ripea.distribucio.regla.autenticacio.basic','false','Client REST per a la creació de regles amb tipus d''autenticació BASIC','5','BOOL','0','1','0','1','0');
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('1','VALIDATE_SIGNATURE','es.caib.ripea.plugins.validatesignature.afirmacxf.authorization.password','RIPEA','Contrasenya de AfirmaCxf','4','PASSWORD','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('1','GESCONADM','es.caib.ripea.plugin.procediment.rolsac.service.password','distribucio_rolsac','Contrasenya del plugin','4','PASSWORD','0','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','FIRMA_VIAFIRMA','es.caib.ripea.plugin.viafirma.caib.authmode','client_auth','Mode d''autenticació','0','TEXT','0','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','FIRMA_VIAFIRMA','es.caib.ripea.plugin.viafirma.caib.group.codi','apb','Codi de l''aplicació (informar si la propietat anterior és falsa)','0','TEXT','0','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','FIRMA_VIAFIRMA','es.caib.ripea.plugin.viafirma.caib.authtype','OAUTH_APPLICATION','Tipus d''autenticació OAUTH','0','TEXT','0','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','FIRMA_VIAFIRMA','es.caib.ripea.plugin.viafirma.caib.app.codi',null,'Codi de l''aplicació CAIB','12','TEXT','0','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('1','DISTRIBUCIO','es.caib.ripea.distribucio.backofficeIntegracio.ws.password',null,'Contrasenya del plugin','3','PASSWORD','0','0','0','1','0');
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','DIGITALITZACIO','es.caib.ripea.plugin.digitalitzacio.scanner.mock','false','Resultat de l''escaneig fictici','6','BOOL','1','0','0','1','0');
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','SUMMARIZE','es.caib.ripea.plugin.summarize.model.maxTokens','8192','Màxim de tokens (típicament paraules, però no sempre) que suporta el model en la petició i resposta combinades.','0','INT','1','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','SUMMARIZE','es.caib.ripea.plugin.summarize.debug','false','Activar logs','10','BOOL','1','0','0','1','0');

Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','ALTRES','es.caib.ripea.conversio.definitiu','false','Activar la conversió a definitiu','0','BOOL','0','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','ALTRES','es.caib.ripea.notificacio.guardar.certificacio.expedient','true','Tipus de document específic per a certificació de NOTIB','1','BOOL','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','ALTRES','es.caib.ripea.carpetes.defecte','false','Carpetes per defecte','4','BOOL','0','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','ALTRES','es.caib.ripea.incorporar.justificant','false','Activar la incorporació del justificant','5','BOOL','0','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','ALTRES','es.caib.ripea.interessats.permet.canvi.tipus','false','Permetre canviar el tipus dels interessats en importar anotacions','16','BOOL','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.descarregar.imprimible.nofirmats','false','Permet imprimibles no firmats','10','BOOL','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.expedient.permetre.reobrir','true','Permetre reobrir expedients tancats','11','BOOL','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.document.modificar.custodiats','false','Poder canviar el tipus de document a documents definitius.','12','BOOL','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.creacio.documents.publicar.activa','true','Habilita l''opció de menú per publicar documents.','14','BOOL','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.documents.firma.biometrica.activa','false','Activar firma biomètrica','15','BOOL','0','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.documents.validacio.url','https://se.caib.es/concsvapi/interna/printable/uuid','URL de validació de documents imprimibles','17','TEXT','0','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.creacio.documents.moure.mateix.expedient','false','Permet moure documents creats dins el mateix expedient','19','BOOL','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.importacio.expedient.relacionat.activa','false','Importar expedients relacionats a la llista de documents','20','BOOL','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.document.esborrar.finals','true','Permetre esborrar documents CUSTODIATS, FIRMATS, DEFINITIUS I IMPORTATS','21','BOOL','0','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.estat.elaboracio.identificador.origen.obligat','EE02, EE03, EE04','Estats d''elaboració on és obligatori el camp "Identificador ENI del document origen", separats per coma (EE02, EE03...)','22','TEXT','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.identificador.origen.mascara','true','Aplicar màscara al camp "Identificador del document origen"','23','BOOL','0','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.document.propagar.modificacio.arxiu','false','Propagar les modificacions d''un document a l''arxiu (també habilita la modificació de la data del document)','24','BOOL','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.filtre.data.creacio.actiu','true','Filtrar llistat d''expedients amb data de creació inicial per defecte','25','BOOL','0','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.document.deteccio.firma.automatica','true','Detectar de forma automàtica la firma dels documents','26','BOOL','0','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.desactivar.comprovacio.duplicat.nom.arxiu','false','Desactivar la comprovació de noms duplicats a l''arxiu','27','BOOL','1','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.document.guardar.definitiu.arxiu','true','Fer els documents firmats definitius a l''arxiu quan es creen','28','BOOL','0','1','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.numero.expedient.separador','/','Separador del número d''expedient','29','TEXT','0','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.numero.expedient.propagar.arxiu','false','Propagar el número d''expedient a l''arxiu','30','BOOL','0','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.document.enviar.contingut.existent','true','Enviar el contingut del document a l''arxiu sense modificar','31','BOOL','0','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.expedient.propagar.metadades','true','Permetre enviar les metadades marcades com "Enviables arxiu" a l''arxiu','32','BOOL','0','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.expedient.generar.urls.instruccio','false','Permetre generar URLs d''instrucció','32','BOOL','0','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.notificacio.multiple.pdf.concatenar','false','En notificar documents múltiples, concatenar versions imprimibles de documents si tots els documents seleccionats per notificar són PDF','33','BOOL','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.expedient.exportar.inside','false','Permetre l''exportació ENI per importar a INSIDE','38','BOOL','0','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.expedient.tancament.logic','false','Habilitar tancament lògic dels expedients','39','BOOL','0','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.obtenir.data.firma.atributs.document','false','Obtenir informació de la firma utilitzant les metadades del document','40','BOOL','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.firma.detectar.attached.validate.signature','true','Validar la firma en adjuntar un contingut','10','BOOL','0','0','0','0','0');

Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','CONTINGUT','es.caib.ripea.carpetes.mantenir.estat','false','Mantenir l''estat de les carpetes (oberta o tancada) fins que es tanqui el navegador','41','BOOL','0','0','0','1','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','GENERAL','es.caib.ripea.entorn',null,'Entorn on es troba l''aplicació','4','TEXT','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','LOGS','es.caib.ripea.mostrar.logs.email','true','Activar logs per als correus electrònics','0','BOOL','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','LOGS','es.caib.ripea.mostrar.logs.creacio.contingut','true','Activar logs per creació de contingut','2','BOOL','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','LOGS','es.caib.ripea.activar.logs.permisos','true','Activar logs per permisos','3','BOOL','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','LOGS','es.caib.ripea.mostrar.logs.rendiment','true','Generar logs de rendiment','7','BOOL','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','LOGS','es.caib.ripea.mostrar.logs.rendiment.descarregar.anotacio','true','Generar logs de rendiment de funcions de anotacions','7','BOOL','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','LOGS','es.caib.ripea.activar.logs.grups','true','Activar logs per grups','8','BOOL','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','LOGS','es.caib.ripea.mostrar.logs.cercador.anotacions','true','Activar logs per cercador d''anotacions','9','BOOL','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','LOGS','es.caib.ripea.mostrar.logs.segonpla','true','Activar logs per segon pla','10','BOOL','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','LOGS','es.caib.ripea.mostrar.logs.integracio','true','Activar logs per integracions','11','BOOL','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','SCHEDULLED','es.caib.ripea.segonpla.max.reintents.anotacions.pendents.enviar.distribucio','3','Nombre de reintents per canviar l''estat d''anotacions a Distribució','0','INT','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
('0','SCHEDULLED','es.caib.ripea.segonpla.guardar.arxiu.max.reintents.expedients','5','Nombre de reintents de guardar expedients en arxiu','3','INT','0','0','0','0','0');
Insert into IPA_CONFIG (JBOSS_PROPERTY,GROUP_CODE,KEY,VALUE,DESCRIPTION,POSITION,TYPE_CODE,CONFIGURABLE_ORGAN,CONFIGURABLE_ENTITAT_ACTIU,CONFIGURABLE_ORGAN_ACTIU,CONFIGURABLE,CONFIGURABLE_ORG_DESCENDENTS) values
...
Insert into IPA_PINBAL_SERVEI (ID,CODI,DOC_PERMES_DNI,DOC_PERMES_NIF,DOC_PERMES_CIF,DOC_PERMES_NIE,DOC_PERMES_PAS,ACTIU,NOM) values ('1','SVDDGPCIWS02','0','0','0','0','0','1','Consulta de dades d''identitat');
Insert into IPA_PINBAL_SERVEI (ID,CODI,DOC_PERMES_DNI,DOC_PERMES_NIF,DOC_PERMES_CIF,DOC_PERMES_NIE,DOC_PERMES_PAS,ACTIU,NOM) values ('2','SVDDGPVIWS02','0','0','0','0','0','1','Verificació de dades d''identitat');
Insert into IPA_PINBAL_SERVEI (ID,CODI,DOC_PERMES_DNI,DOC_PERMES_NIF,DOC_PERMES_CIF,DOC_PERMES_NIE,DOC_PERMES_PAS,ACTIU,NOM) values ('3','SVDCCAACPASWS01','0','0','0','0','0','1','Estar al corrent d''obligacions tributàries per a sol·licitud de subvencions i ajudes de la CCAA');
Insert into IPA_PINBAL_SERVEI (ID,CODI,DOC_PERMES_DNI,DOC_PERMES_NIF,DOC_PERMES_CIF,DOC_PERMES_NIE,DOC_PERMES_PAS,ACTIU,NOM) values ('4','SVDSCDDWS01','0','0','0','0','0','1','Servei de consulta de dades de discapacitat');
Insert into IPA_PINBAL_SERVEI (ID,CODI,DOC_PERMES_DNI,DOC_PERMES_NIF,DOC_PERMES_CIF,DOC_PERMES_NIE,DOC_PERMES_PAS,ACTIU,NOM) values ('5','SCDCPAJU','0','0','0','0','0','1','Servei de consulta de padró de convivència');
Insert into IPA_PINBAL_SERVEI (ID,CODI,DOC_PERMES_DNI,DOC_PERMES_NIF,DOC_PERMES_CIF,DOC_PERMES_NIE,DOC_PERMES_PAS,ACTIU,NOM) values ('6','SVDSCTFNWS01','0','0','0','0','0','1','Servei de consulta de família nombrosa');
Insert into IPA_PINBAL_SERVEI (ID,CODI,DOC_PERMES_DNI,DOC_PERMES_NIF,DOC_PERMES_CIF,DOC_PERMES_NIE,DOC_PERMES_PAS,ACTIU,NOM) values ('7','SVDCCAACPCWS01','0','0','0','0','0','1','Estar al corrent d''obligacions tributàries per a la contractació amb la CCAA');
Insert into IPA_PINBAL_SERVEI (ID,CODI,DOC_PERMES_DNI,DOC_PERMES_NIF,DOC_PERMES_CIF,DOC_PERMES_NIE,DOC_PERMES_PAS,ACTIU,NOM) values ('8','Q2827003ATGSS001','0','0','0','0','0','1','Estar al corrent de pagament amb la Seguretat Social');
Insert into IPA_PINBAL_SERVEI (ID,CODI,DOC_PERMES_DNI,DOC_PERMES_NIF,DOC_PERMES_CIF,DOC_PERMES_NIE,DOC_PERMES_PAS,ACTIU,NOM) values ('9','SVDDELSEXWS01','0','0','0','0','0','1','Consulta d''inexistència de delictes sexuals per dades de filiació');
Insert into IPA_PINBAL_SERVEI (ID,CODI,DOC_PERMES_DNI,DOC_PERMES_NIF,DOC_PERMES_CIF,DOC_PERMES_NIE,DOC_PERMES_PAS,ACTIU,NOM) values ('10','SCDHPAJU','0','0','0','0','0','1','Servei de consulta de padró històric');
Insert into IPA_PINBAL_SERVEI (ID,CODI,DOC_PERMES_DNI,DOC_PERMES_NIF,DOC_PERMES_CIF,DOC_PERMES_NIE,DOC_PERMES_PAS,ACTIU,NOM) values ('11','NIVRENTI','1','1','0','0','0','0','Consulta del nivell de renda');
Insert into IPA_PINBAL_SERVEI (ID,CODI,DOC_PERMES_DNI,DOC_PERMES_NIF,DOC_PERMES_CIF,DOC_PERMES_NIE,DOC_PERMES_PAS,ACTIU,NOM) values ('12','ECOT103','0','0','0','0','0','0','Estar al corrent d''obligacions tributàries per a sol·licitud de subvencions i ajudes amb indicació d''incompliments');
Insert into IPA_PINBAL_SERVEI (ID,CODI,DOC_PERMES_DNI,DOC_PERMES_NIF,DOC_PERMES_CIF,DOC_PERMES_NIE,DOC_PERMES_PAS,ACTIU,NOM) values ('13','SVDDGPRESIDENCIALEGALDOCWS01','0','0','0','0','0','1','Servei de consulta de dades de residència legal d''estrangers per documentació');
Insert into IPA_PINBAL_SERVEI (ID,CODI,DOC_PERMES_DNI,DOC_PERMES_NIF,DOC_PERMES_CIF,DOC_PERMES_NIE,DOC_PERMES_PAS,ACTIU,NOM) values ('14','SVDRRCCNACIMIENTOWS01','0','0','0','0','0','1','Servei de consulta de naixement');
Insert into IPA_PINBAL_SERVEI (ID,CODI,DOC_PERMES_DNI,DOC_PERMES_NIF,DOC_PERMES_CIF,DOC_PERMES_NIE,DOC_PERMES_PAS,ACTIU,NOM) values ('15','SVDRRCCMATRIMONIOWS01','0','0','0','0','0','1','Servei de consulta de matrimoni');
Insert into IPA_PINBAL_SERVEI (ID,CODI,DOC_PERMES_DNI,DOC_PERMES_NIF,DOC_PERMES_CIF,DOC_PERMES_NIE,DOC_PERMES_PAS,ACTIU,NOM) values ('16','SVDRRCCDEFUNCIONWS01','0','0','0','0','0','1','Servei de consulta de defunció');
Insert into IPA_PINBAL_SERVEI (ID,CODI,DOC_PERMES_DNI,DOC_PERMES_NIF,DOC_PERMES_CIF,DOC_PERMES_NIE,DOC_PERMES_PAS,ACTIU,NOM) values ('17','SVDBECAWS01','0','0','0','0','0','1','Servei de consulta de condició de becat');
