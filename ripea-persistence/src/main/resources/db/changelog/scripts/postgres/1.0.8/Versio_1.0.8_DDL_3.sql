...
ALTER TABLE IPA_EXPLOT_FET ADD COLUMN FIR_ENVIAT BIGINT DEFAULT 0 NOT NULL;
ALTER TABLE IPA_EXPLOT_FET ADD COLUMN FIR_ENVIAT_TOT BIGINT DEFAULT 0 NOT NULL;
