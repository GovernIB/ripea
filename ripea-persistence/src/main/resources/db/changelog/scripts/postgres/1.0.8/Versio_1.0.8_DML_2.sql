...
DECLARE
    ...
    V_ORDRE         INTEGER;
    V_CODI          VARCHAR := 'NOTIFICACIO_MULTIPLE';
    V_NOM           VARCHAR := 'Notificació de múltiples documents';
    V_DESCRIPCIO    VARCHAR := 'Al seleccionar varis documents de un expedient i notificar-los conjuntament, si son tots PDFs es combinarán en un sol PDF, en cas contrari es generará un zip que contendrá els documents.';
    R               RECORD;
BEGIN
    FOR R IN
    ...
    LOOP
        ...
        VALUES (
            V_METANODE_ID, V_CODI, V_NOM, V_DESCRIPCIO, 'DOCUMENT', R.entitat_id, TRUE, 0,
