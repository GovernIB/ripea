...
CREATE TABLE ipa_explot_fet (
    ...
    ano_pendent         BIGINT NOT NULL,
    ano_pendent_tot     BIGINT NOT NULL,
    ...
    com_enviada         BIGINT NOT NULL,
    com_enviada_tot     BIGINT NOT NULL,
    fir_enviada         BIGINT NOT NULL,
    fir_enviada_tot     BIGINT NOT NULL,
