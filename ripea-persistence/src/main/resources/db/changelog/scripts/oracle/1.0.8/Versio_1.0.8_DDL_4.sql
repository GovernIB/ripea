...
-- el valor ja es real.
ALTER TABLE IPA_EXPLOT_FET ADD TAS_CREADA NUMBER(38,0) DEFAULT 0 NOT NULL;
ALTER TABLE IPA_EXPLOT_FET ADD TAS_CREADA_TOT NUMBER(38,0) DEFAULT 0 NOT NULL;
ALTER TABLE IPA_EXPLOT_FET ADD TAS_NOTFIN_FORA_TERMINI NUMBER(38,0) DEFAULT 0 NOT NULL;
ALTER TABLE IPA_EXPLOT_FET ADD TAS_NOTFIN_FORA_TERMINI_TOT NUMBER(38,0) DEFAULT 0 NOT NULL;
