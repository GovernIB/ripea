...
@Setter
@Entity
@Table(name = BaseConfig.DB_PREFIX + "historic")
...
public class HistoricEntity extends RipeaAuditable<Long> {
	...
	@ForeignKey(name = BaseConfig.DB_PREFIX + "historic_entitat_fk")
	protected EntitatEntity entitat;

	@ManyToOne(optional = true, fetch = FetchType.EAGER)
	@JoinColumn(name = "organ_id")
	@ForeignKey(name = BaseConfig.DB_PREFIX + "historic_organ_fk")
	protected OrganGestorEntity organGestor;

	@ManyToOne(optional = false, fetch = FetchType.EAGER)
	@JoinColumn(name = "metaexpedient_id")
	@ForeignKey(name = BaseConfig.DB_PREFIX + "historic_metaexp_fk")
