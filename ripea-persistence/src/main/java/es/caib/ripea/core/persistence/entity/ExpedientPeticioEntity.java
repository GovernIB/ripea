...
public class ExpedientPeticioEntity extends RipeaAuditable<Long> {
	...
	@ForeignKey(name = BaseConfig.DB_PREFIX + "usuari_actual_exp_pet_fk")
	...
	@ForeignKey(name = BaseConfig.DB_PREFIX + "exp_pet_metaexp_fk")
	...
	@ForeignKey(name = BaseConfig.DB_PREFIX + "expedient_registre_fk")
	...
	@ForeignKey(name = BaseConfig.DB_PREFIX + "grup_exp_pet_fk")
