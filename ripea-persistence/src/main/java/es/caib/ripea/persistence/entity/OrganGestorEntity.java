 ...
 */
@Entity
@Table(name = BaseConfig.DB_PREFIX + "organ_gestor", uniqueConstraints = @UniqueConstraint(name = BaseConfig.DB_PREFIX + "organ_gestor_uk", columnNames = {
        "codi", "entitat_id" }))
...
public class OrganGestorEntity extends RipeaAuditable<Long> {
    ...
    @ForeignKey(name = BaseConfig.DB_PREFIX + "entitat_organ_gestor_fk")
