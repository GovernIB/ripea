...
(
  ...
  VF_VALIDATE_CODE_ENABLED 	BOOLEAN,
  VF_VALIDATE_CODE 			CHARACTER VARYING(100),
  VF_REBRE_CORREU 			BOOLEAN,
  PUB_TIPUS            		integer,
...
CREATE TABLE IPA_REGISTRE_ANNEX (
	...
	FIRMA_PERFIL character varying (20),
	FIRMA_TAMANY integer,
	FIRMA_TIPUS character varying (10),
