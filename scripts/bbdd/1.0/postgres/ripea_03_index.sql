...
CREATE INDEX IPA_REPRESENT_INTERESSAT_FK_I ON IPA_INTERESSAT(REPRESENTANT_ID);
...
CREATE INDEX IPA_REMITENT_CONTMOV_FK_I ON IPA_CONT_MOV(REMITENT_CODI);
...
CREATE INDEX IPA_AGAFATPER_EXPEDIENT_FK_I ON IPA_EXPEDIENT(AGAFAT_PER_CODI);
...
CREATE INDEX IPA_EXPEDIENT_DOCENV_FK_I ON IPA_DOCUMENT_ENVIAMENT(EXPEDIENT_ID);
CREATE INDEX IPA_DOCUMENT_DOCENV_FK_I ON IPA_DOCUMENT_ENVIAMENT(DOCUMENT_ID);
CREATE INDEX IPA_USUCRE_DOCENV_FK_I ON IPA_DOCUMENT_ENVIAMENT(CREATEDBY_CODI);
CREATE INDEX IPA_USUMOD_DOCENV_FK_I ON IPA_DOCUMENT_ENVIAMENT(LASTMODIFIEDBY_CODI);
...
CREATE INDEX IPA_REGANX_REGANXFIR_FK_I ON IPA_REGISTRE_ANNEX_FIRMA(ANNEX_ID);
...
CREATE INDEX IPA_REPRESENTANT_REGINT_FK_I ON IPA_REGISTRE_INTER(REPRESENTANT_ID);
CREATE INDEX IPA_REPRESENTAT_REGINT_FK_I ON IPA_REGISTRE_INTER(REPRESENTAT_ID);
...
CREATE INDEX IPA_EXMAS_EXMASCON_FK_I ON IPA_MASSIVA_CONTINGUT(EXECUCIO_MASSIVA_ID);
CREATE INDEX IPA_CONTINGUT_EXMASCON_FK_I ON IPA_MASSIVA_CONTINGUT(CONTINGUT_ID);
