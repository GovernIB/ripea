...
ALTER TABLE ONLY IPA_ORGAN_GESTOR 		ADD CONSTRAINT IPA_ORGAN_GESTOR_PK			PRIMARY KEY (ID);
ALTER TABLE ONLY IPA_ORGAN_GESTOR 		ADD CONSTRAINT IPA_ORGAN_GESTOR_UK			UNIQUE      (CODI, ENTITAT_ID);
ALTER TABLE ONLY IPA_EXPEDIENT_SEGUIDOR ADD CONSTRAINT IPA_EXP_SEGUIDOR_PK 			PRIMARY KEY (EXPEDIENT_ID, SEGUIDOR_CODI);

ALTER TABLE ONLY IPA_PORTAFIRMES_BLOCK ADD CONSTRAINT IPA_PORTAFIRMES_BLOCK_PK PRIMARY KEY (ID);
ALTER TABLE ONLY IPA_PORTAFIRMES_BLOCK_INFO ADD CONSTRAINT IPA_PORTAFIRMES_BLOCK_INFO_PK PRIMARY KEY (ID);
...
ALTER TABLE IPA_METAEXPEDIENT ADD CONSTRAINT IPA_ORGAN_GESTOR_METAEXP_FK FOREIGN KEY (ORGAN_GESTOR_ID) REFERENCES IPA_ORGAN_GESTOR (ID);
...
ALTER TABLE IPA_EXPEDIENT ADD CONSTRAINT IPA_ORGAN_GESTOR_EXP_FK FOREIGN KEY (ORGAN_GESTOR_ID) REFERENCES IPA_ORGAN_GESTOR (ID);
...
ALTER TABLE IPA_ORGAN_GESTOR ADD CONSTRAINT IPA_ENTITAT_ORGAN_GESTOR_FK FOREIGN KEY (ENTITAT_ID) REFERENCES IPA_ENTITAT(ID);
 
ALTER TABLE IPA_EXPEDIENT_SEGUIDOR ADD CONSTRAINT IPA_PERSONA_EXPSEGUIDOR_FK FOREIGN KEY (SEGUIDOR_CODI) REFERENCES IPA_USUARI (CODI);
ALTER TABLE IPA_EXPEDIENT_SEGUIDOR ADD CONSTRAINT IPA_EXPEDIENT_EXPSEGUIDOR_FK FOREIGN KEY (EXPEDIENT_ID) REFERENCES IPA_EXPEDIENT (ID);

ALTER TABLE IPA_PORTAFIRMES_BLOCK ADD CONSTRAINT IPA_SIGNBLK_DOCENVDOC_FK FOREIGN KEY (DOCUMENT_ENVIAMENT_ID) REFERENCES IPA_DOCUMENT_ENVIAMENT(ID);
ALTER TABLE IPA_PORTAFIRMES_BLOCK_INFO ADD CONSTRAINT IPA_SIGNINFO_SIGNBLK_FK FOREIGN KEY (PORTAFIRMES_BLOCK_ID) REFERENCES IPA_PORTAFIRMES_BLOCK(ID);
