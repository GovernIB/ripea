...
ALTER TABLE IPA_CONT_LOG ADD CONSTRAINT IPA_CONTINGUT_CONTLOG_FK FOREIGN KEY (CONTINGUT_ID) REFERENCES IPA_CONTINGUT (ID);
...
ALTER TABLE IPA_CONT_MOV ADD CONSTRAINT IPA_CONTINGUT_CONTMOV_FK FOREIGN KEY (CONTINGUT_ID) REFERENCES IPA_CONTINGUT (ID);
...
ALTER TABLE IPA_REGISTRE_ANNEX_FIRMA ADD CONSTRAINT IPA_REGANX_REGANXFIR_FK FOREIGN KEY (ANNEX_ID) REFERENCES IPA_REGISTRE_ANNEX (ID);
