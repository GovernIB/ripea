...
GRANT SELECT, UPDATE, INSERT, DELETE ON IPA_METAEXP_TASCA WWW_RIPEA;
GRANT SELECT, UPDATE, INSERT, DELETE ON IPA_EXPEDIENT_PETICIO WWW_RIPEA;
GRANT SELECT, UPDATE, INSERT, DELETE ON IPA_REGISTRE_INTERESSAT WWW_RIPEA;
GRANT SELECT, UPDATE, INSERT, DELETE ON IPA_DOCUMENT_ENVIAMENT_INTER WWW_RIPEA;
GRANT SELECT, UPDATE, INSERT, DELETE ON IPA_VIAFIRMA_USUARI WWW_RIPEA;
GRANT SELECT, UPDATE, INSERT, DELETE ON IPA_USUARI_VIAFIRMA_RIPEA WWW_RIPEA;
GRANT SELECT, UPDATE, INSERT, DELETE ON IPA_DOCUMENT_ENVIAMENT_DIS WWW_RIPEA;
GRANT SELECT, UPDATE, INSERT, DELETE ON IPA_EXPEDIENT_TASCA WWW_RIPEA;
GRANT SELECT, UPDATE, INSERT, DELETE ON IPA_TIPUS_DOCUMENTAL WWW_RIPEA;
GRANT SELECT, UPDATE, INSERT, DELETE ON IPA_DOMINI WWW_RIPEA;

GRANT SELECT, UPDATE, INSERT, DELETE ON IPA_PORTAFIRMES_BLOCK WWW_RIPEA;
GRANT SELECT, UPDATE, INSERT, DELETE ON IPA_PORTAFIRMES_BLOCK_INFO WWW_RIPEA;