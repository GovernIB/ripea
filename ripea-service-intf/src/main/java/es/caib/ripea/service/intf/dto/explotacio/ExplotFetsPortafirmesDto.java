...
/**
 * Fets d'explotació d'enviaments a portafirmes obtinguts amb una única consulta agregada sobre DocumentPortafirmesEntity.
 *
...
@Getter
@AllArgsConstructor
public class ExplotFetsPortafirmesDto {
	...
	private Long pausadesTotal;
	private Long pausadesTotalAhir;
	private Long firmadesTotal;
	private Long firmadesTotalAhir;
	private Long rebutjadesTotal;
	private Long rebutjadesTotalAhir;
	private Long parcialsTotal;
	private Long parcialsTotalAhir;
