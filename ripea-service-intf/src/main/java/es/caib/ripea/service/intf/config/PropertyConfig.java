...
public class PropertyConfig {
	...
	public static final String COMANDA_PLUGIN_CONNECT_TIMEOUT		= "es.caib.ripea.plugin.comanda.connect.timeout";
	public static final String COMANDA_PLUGIN_READ_TIMEOUT			= "es.caib.ripea.plugin.comanda.read.timeout";
	...
	public static final String TANCAR_AMB_DOCUMENTS_FALTANTS                        = "es.caib.ripea.expedient.tancar.documents.faltants";
