...
ALTER TABLE ipa_organ_gestor ADD utilitzar_cif_pinbal BOOLEAN DEFAULT FALSE;

-- Changeset db/changelog/changes/0.9.101/1316.yaml::1691495012174-1::limit
ALTER TABLE ipa_document_enviament ADD pf_avis_firma_parcial BOOLEAN;

UPDATE ipa_document_enviament SET pf_avis_firma_parcial = FALSE;

ALTER TABLE ipa_execucio_massiva ADD pfirmes_avis_firma_parcial BOOLEAN;

UPDATE ipa_execucio_massiva SET pfirmes_avis_firma_parcial = FALSE;
