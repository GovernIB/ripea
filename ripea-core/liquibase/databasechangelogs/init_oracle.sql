...
CREATE TABLE ipa_cont_mov (id NUMBER(38, 0) NOT NULL, contingut_id NUMBER(38, 0) NOT NULL, origen_id NUMBER(38, 0), desti_id NUMBER(38, 0) NOT NULL, remitent_codi VARCHAR2(64), comentari VARCHAR2(256), createdby_codi VARCHAR2(64), createddate TIMESTAMP, lastmodifiedby_codi VARCHAR2(64), lastmodifieddate TIMESTAMP, CONSTRAINT ipa_cont_mov_pk PRIMARY KEY (id));
...
CREATE TABLE ipa_document_enviament_inter (ID NUMBER(38, 0) NOT NULL, DOCUMENT_ENVIAMENT_ID NUMBER(38, 0) NOT NULL, INTERESSAT_ID NUMBER(38, 0) NOT NULL, NOT_ENV_REF VARCHAR2(100), CREATEDBY_CODI VARCHAR2(64), CREATEDDATE TIMESTAMP, LASTMODIFIEDBY_CODI VARCHAR2(64), LASTMODIFIEDDATE TIMESTAMP, NOT_ENV_DAT_ESTAT VARCHAR2(20), NOT_ENV_DAT_DATA TIMESTAMP, NOT_ENV_DAT_ORIG VARCHAR2(20), NOT_ENV_CERT_DATA TIMESTAMP, NOT_ENV_CERT_ORIG VARCHAR2(20), ERROR NUMBER(1), ERROR_DESC VARCHAR2(2048), NOT_ENV_REGISTRE_DATA date, NOT_ENV_REGISTRE_NUMERO NUMBER(38, 0), NOT_ENV_REGISTRE_NUM_FORMATAT VARCHAR2(50), createdby_codi VARCHAR2(64), createddate TIMESTAMP, lastmodifiedby_codi VARCHAR2(64), lastmodifieddate TIMESTAMP, CONSTRAINT ipa_document_env_inter_pk PRIMARY KEY (ID));
...
ALTER TABLE ipa_expedient_peticio ADD CONSTRAINT ipa_exp_pet_exp_fk FOREIGN KEY (expedient_id) REFERENCES ipa_expedient (ip);
...
ALTER TABLE ipa_expedient_rel ADD CONSTRAINT ipa_exp_rel_expedient_fk FOREIGN KEY (expedient_rel_id) REFERENCES ipa_expedient (id);
...
ALTER TABLE ipa_cont_log_ ADD CONSTRAINT ipa_cont_log_lastmodby_fk FOREIGN KEY (lastmodifiedby_codi) REFERENCES ipa_usuari (codi);
...
CREATE UNIQUE INDEX ipa_expedient_filtre_uk ON ipa_expedient_filtre(lasmodifiedby_codi, filter_name);

-- Changeset db/changelog/initial_schema_index.yaml::init-index-6::limit (generated)
ALTER TABLE ipa_expedient_filtre ADD CONSTRAINT ipa_expedient_filtre_uk UNIQUE (lasmodifiedby_codi, filter_name) USING INDEX ipa_expedient_filtre_uk;
...
CREATE INDEX ipa_mnode_mdada_metadada_fk_i ON ipa_metanode_medatata(metadada_id);
...
CREATE INDEX ipa_mnode_mdada_metanode_fk_i ON ipa_metanode_medatata(metanode_id);
