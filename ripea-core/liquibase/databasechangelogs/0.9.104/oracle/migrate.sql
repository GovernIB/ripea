...
CREATE TABLE IPA_FLUX_FIRMA_USUARI (ID NUMBER(19) NOT NULL, NOM VARCHAR2(80 CHAR) NOT NULL, DESCRIPCIO VARCHAR2(256 CHAR), PORTAFIRMES_FLUXID VARCHAR2(64 CHAR) NOT NULL, USUARI_CODI VARCHAR2(64 CHAR) NOT NULL, ENTITAT_ID NUMBER(19) NOT NULL, CREATEDBY_CODI VARCHAR2(64 CHAR), CREATEDDATE TIMESTAMP, LASTMODIFIEDBY_CODI VARCHAR2(64 CHAR), LASTMODIFIEDDATE TIMESTAMP, CONSTRAINT IPA_FLUX_FIRMA_USUARI_PK PRIMARY KEY (ID));
