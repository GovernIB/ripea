...
CREATE TABLE IPA_FLUX_FIRMA_USUARI (ID numeric(19) NOT NULL, NOM VARCHAR(80) NOT NULL, DESCRIPCIO VARCHAR(256), DESTINATARIS VARCHAR(512), PORTAFIRMES_FLUXID VARCHAR(64) NOT NULL, USUARI_CODI VARCHAR(64) NOT NULL, ENTITAT_ID numeric(19) NOT NULL, CREATEDBY_CODI VARCHAR(64), CREATEDDATE TIMESTAMP WITHOUT TIME ZONE, LASTMODIFIEDBY_CODI VARCHAR(64), LASTMODIFIEDDATE TIMESTAMP WITHOUT TIME ZONE, CONSTRAINT IPA_FLUX_FIRMA_USUARI_PK PRIMARY KEY (ID));
