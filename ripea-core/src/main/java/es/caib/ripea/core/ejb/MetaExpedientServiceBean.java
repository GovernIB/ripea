...
public class MetaExpedientServiceBean implements MetaExpedientService {
	...
	public List<MetaExpedientDto> findActiusAmbEntitatPerModificacio(
			Long entitatId, boolean checkPerMassiuAdmin, String rolActual) {
		return delegate.findActiusAmbEntitatPerModificacio(entitatId, checkPerMassiuAdmin, rolActual);
	}	

	@Override
	@RolesAllowed({"tothom"})
	public List<MetaExpedientDto> findActiusAmbEntitatPerLectura(
			Long entitatId, String filtreNomOrCodiSia, String rolActual) {
		return delegate.findActiusAmbEntitatPerLectura(entitatId, filtreNomOrCodiSia, rolActual);
	}
