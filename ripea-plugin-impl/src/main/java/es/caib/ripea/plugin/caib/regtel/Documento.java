...
public class Documento {
    ...
    @XmlElementRef(name = "referenciaRDS", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "datosFichero", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "firmas", type = JAXBElement.class, required = false)
