 ...
 * 
 */
@WebServiceClient(name = "BackofficeFacadeService", targetNamespace = "urn:es:caib:regtel:ws:v2:services", wsdlLocation = "file:/home/siona/git/ripea/ripea-plugin-impl/wsdl/sistra-regtel/BackofficeFacade.wsdl")
    ...
    extends Service
{
    ...
    private final static QName BACKOFFICEFACADESERVICE_QNAME = new QName("urn:es:caib:regtel:ws:v2:services", "BackofficeFacadeService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/home/siona/git/ripea/ripea-plugin-impl/wsdl/sistra-regtel/BackofficeFacade.wsdl");
