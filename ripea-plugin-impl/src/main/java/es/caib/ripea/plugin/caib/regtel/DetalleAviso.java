...
public class DetalleAviso {
    ...
    @XmlElementRef(name = "fechaEnvio", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> fechaEnvio;
    protected boolean confirmarEnvio;
    @XmlElementRef(name = "confirmadoEnvio", type = JAXBElement.class, required = false)
