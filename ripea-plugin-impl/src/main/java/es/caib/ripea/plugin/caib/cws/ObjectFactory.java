 ...
 * generated in the es.caib.ripea.plugin.caib.cws package. 
...
public class ObjectFactory {
    ...
    private final static QName _VisualFileArchiveOptions_QNAME = new QName("", "archive-options");
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.caib.ripea.plugin.caib.cws
     * 
     */
    ...
    public JAXBElement<ArchiveOptions> createVisualFileArchiveOptions(ArchiveOptions value) {
        return new JAXBElement<ArchiveOptions>(_VisualFileArchiveOptions_QNAME, ArchiveOptions.class, VisualFile.class, value);
    }
    ...
    public JAXBElement<ArchiveOptions> createDownloadResponseDocumentArchiveOptions(ArchiveOptions value) {
        return new JAXBElement<ArchiveOptions>(_VisualFileArchiveOptions_QNAME, ArchiveOptions.class, DownloadResponseDocument.class, value);
    }
    ...
    public JAXBElement<ArchiveOptions> createAnnexArchiveOptions(ArchiveOptions value) {
        return new JAXBElement<ArchiveOptions>(_VisualFileArchiveOptions_QNAME, ArchiveOptions.class, Annex.class, value);
    }
    ...
    public JAXBElement<ArchiveOptions> createUpdateRequestDocumentArchiveOptions(ArchiveOptions value) {
        return new JAXBElement<ArchiveOptions>(_VisualFileArchiveOptions_QNAME, ArchiveOptions.class, UpdateRequestDocument.class, value);
    }
    ...
    public JAXBElement<ArchiveOptions> createSignatureFileArchiveOptions(ArchiveOptions value) {
        return new JAXBElement<ArchiveOptions>(_VisualFileArchiveOptions_QNAME, ArchiveOptions.class, SignatureFile.class, value);
    }
    ...
    public JAXBElement<ArchiveOptions> createListResponseDocumentArchiveOptions(ArchiveOptions value) {
        return new JAXBElement<ArchiveOptions>(_VisualFileArchiveOptions_QNAME, ArchiveOptions.class, ListResponseDocument.class, value);
    }
    ...
    public JAXBElement<ArchiveOptions> createUploadRequestDocumentArchiveOptions(ArchiveOptions value) {
        return new JAXBElement<ArchiveOptions>(_VisualFileArchiveOptions_QNAME, ArchiveOptions.class, UploadRequestDocument.class, value);
    }
