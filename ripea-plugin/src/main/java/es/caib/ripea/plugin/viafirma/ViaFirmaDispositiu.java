...
/**
 * Resposta del sistema de firma viaFirma amb els dispositius d'un usuari
 * 
 * @author Limit Tecnologies <limit@limit.es>
 */
public class ViaFirmaDispositiu implements Serializable {
	...
	private static final long serialVersionUID = -326719992099371910L;
