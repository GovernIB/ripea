 ...
 * generated in the es.caib.ripea.plugin.caib.regtel package. 
...
public class ObjectFactory {
    ...
    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.caib.ripea.plugin.caib.regtel
     * 
     */
