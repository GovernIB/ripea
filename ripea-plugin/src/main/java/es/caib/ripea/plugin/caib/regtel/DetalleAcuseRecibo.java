...
public class DetalleAcuseRecibo {
    ...
    @XmlElementRef(name = "fechaAcuseRecibo", type = JAXBElement.class, required = false)
    protected JAXBElement<XMLGregorianCalendar> fechaAcuseRecibo;
    @XmlElementRef(name = "ficheroAcuseRecibo", type = JAXBElement.class, required = false)
    protected JAXBElement<ReferenciaRDS> ficheroAcuseRecibo;
    @XmlElementRef(name = "avisos", type = JAXBElement.class, required = false)
