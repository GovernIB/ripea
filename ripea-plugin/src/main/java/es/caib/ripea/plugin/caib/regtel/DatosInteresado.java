...
public class DatosInteresado {
    ...
    @XmlElementRef(name = "autenticado", type = JAXBElement.class, required = false)
    ...
    @XmlElementRef(name = "codigoPais", type = JAXBElement.class, required = false)
    protected JAXBElement<String> codigoPais;
    @XmlElementRef(name = "nombrePais", type = JAXBElement.class, required = false)
    protected JAXBElement<String> nombrePais;
    @XmlElementRef(name = "codigoProvincia", type = JAXBElement.class, required = false)
    protected JAXBElement<String> codigoProvincia;
    @XmlElementRef(name = "nombreProvincia", type = JAXBElement.class, required = false)
    protected JAXBElement<String> nombreProvincia;
    @XmlElementRef(name = "codigoLocalidad", type = JAXBElement.class, required = false)
    protected JAXBElement<String> codigoLocalidad;
    @XmlElementRef(name = "nombreLocalidad", type = JAXBElement.class, required = false)
