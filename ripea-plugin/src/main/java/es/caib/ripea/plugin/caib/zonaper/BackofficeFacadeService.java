 ...
 * 
 */
@WebServiceClient(name = "BackofficeFacadeService", targetNamespace = "urn:es:caib:zonaper:ws:v2:services", wsdlLocation = "file:/home/siona/git/ripea/ripea-plugin-impl/wsdl/sistra-zonaper/BackofficeFacade.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/home/siona/git/ripea/ripea-plugin-impl/wsdl/sistra-zonaper/BackofficeFacade.wsdl");
    ...
    public BackofficeFacade getBackofficeFacade(WebServiceFeature... features) {
        return super.getPort(new QName("urn:es:caib:zonaper:ws:v2:services", "BackofficeFacade"), BackofficeFacade.class, features);
    }
