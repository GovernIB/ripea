 ...
 * 
 */
@WebServiceClient(name = "BackofficeFacadeService", targetNamespace = "urn:es:caib:bantel:ws:v2:services", wsdlLocation = "file:/home/siona/git/ripea/ripea-plugin-impl/wsdl/sistra-bantel/BackofficeFacade.wsdl")
    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/home/siona/git/ripea/ripea-plugin-impl/wsdl/sistra-bantel/BackofficeFacade.wsdl");
