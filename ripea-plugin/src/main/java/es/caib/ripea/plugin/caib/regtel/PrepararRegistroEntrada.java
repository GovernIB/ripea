...
public class PrepararRegistroEntrada {
    ...
    @XmlElementRef(name = "diasPersistencia", namespace = "urn:es:caib:regtel:ws:v2:model:BackofficeFacade", type = JAXBElement.class, required = false)
