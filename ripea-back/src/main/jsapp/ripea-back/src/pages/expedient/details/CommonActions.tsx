...
export const useCommonActions = (refresh?: () => void) => {
    ...
    const actions:any[] = [
        ...
        },       
        {
            ...
            showInMenu: true,
            onClick: agafar,
            hidden: (row:any) => isAgafatUsuariActual(row) || !row?.usuariActualWrite || rol?.isAdminLectura,
        },
        {
        ...
        {
            label: t('page.expedient.action.relacio.label'),
            icon: "link",
            showInMenu: true,
        ...
        {
            label: t('page.expedient.action.open.label'),
            icon: "undo",
            showInMenu: true,
            onClick: reobrir,
        ...
        {
            label: t('page.expedient.action.sincronitzar.label'),
            icon: "autorenew",
            showInMenu: true,
            onClick: syncArxiu,
            hidden: (row:any) => !row?.potModificar,
