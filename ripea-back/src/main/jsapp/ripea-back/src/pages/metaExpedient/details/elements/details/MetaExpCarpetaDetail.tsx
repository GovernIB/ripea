...
const MetaExpCarpetaDetail = (props:any) => {
...
const useMetaExpCarpetaDetail = () => {
    ...
    const {
        ...
        getOne: apiGetOne,
        currentFields
    } = useResourceApiService('metaExpedientCarpetaResource');
    ...
    const dialog =
        <MuiDialog
            ...
            title={t('page.carpeta.detail.title')}
        ...
        >
            <Load value={entity}>
                <MetaExpCarpetaDetail fields={currentFields} entity={entity}/>
            </Load>
        </MuiDialog>
...
export default useMetaExpCarpetaDetail;