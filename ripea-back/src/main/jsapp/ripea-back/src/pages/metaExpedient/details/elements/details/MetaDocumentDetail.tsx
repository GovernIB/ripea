...
const useMetaDocumentDetail = () => {
    ...
    const dialog =
        <MuiDialog
            ...
            title={t('page.metaDocument.detail.title')}
        ...
        >
            <Load value={entity}>
                <MetaDocumentDetail fields={currentFields} entity={entity}/>
            </Load>
        </MuiDialog>
...
export default useMetaDocumentDetail;