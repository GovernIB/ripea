...
import {FileFormField, formatByteCount} from "../../../components/GridFormField.tsx";
...
import {DataGridPro, GridTreeDataGroupingCell, isAutogeneratedRow} from "@mui/x-data-grid-pro";
...
const ImportarZipForm = () => {
    ...
    const columns:any[] = [
        ...
        },
        {
            ...
            flex: 0.5,
            valueFormatter: (value:number) => value && formatByteCount(value),
        },
        {
            field: 'tipusDocument',
