...
const useCarpetaActions = (entity:any, refresh?: () => void) => {
    ...
    const actions = [
        ...
        /*{
            ...
            hidden: !entity?.potModificarContingut || !user?.sessionScope?.isCreacioCarpetesActiva,
        },*/
        {
            ...
            showInMenu: true,
            onClick: exportarPDF,
            hidden: (row:any) => !entity?.potModificarContingut || !user?.sessionScope?.isCreacioCarpetesActiva || !row?.hasDocumentsFills,
        },
        {
            ...
            hidden: (row:any) => !entity?.potModificarContingut || !user?.sessionScope?.isCreacioCarpetesActiva || !user?.sessionScope?.isExportacioExcelActiva || !row?.hasDocumentsFills,
        },
        {
        ...
        /*{
            ...
            hidden: !entity?.potModificarContingut || !user?.sessionScope?.isCreacioCarpetesActiva || !user?.sessionScope?.isMostrarCopiar,
        },*/
        {
