const translationEs = {
    ...
    page: {
        ...
        contingut: {
            ...
            tabs: {
                contingut: "Contenido",
                infoArxiu: "Información del archivo",
                dades: "Datos",
            ...
            action: {
                ...
                importarExpedient: {
                    label: "Importa expediente relacionado...",
        ...
        anotacio: {
            ...
            action: {
                ...
                canviEstatDistribucio: {
                    label: "Cambia estado a distribución",
        ...
        interessat: {
            ...
            action: {
                ...
                importSGD: {
                    label: "Importa interesados desde Registro...",
                    title: "Importar interesados desde Registro",
                    ok: "Interesados importados correctamente",
                },
				gestGrups: {
				    label: "Gestiona grupos...",
        ...
        expedient: {
            ...
            action: {
                ...
                export: {
                    label: "Exporta los documentos...",
                    button: "Exporta los documentos",
                    title: "Exportar documentos",
                    ok: "Los documentos se han descargado correctamente",
                },
                sincronitzar: {
                    label: "Sincroniza estado con archivo",
                ...
                eliminarRelacio: {
                    label: "Elimina relación",
                    ok: "La relación entre los 2 expedientes se ha eliminado correctamente.",
                },
                excelInteressats: {
                    title: "Descarga plantilla para importar interesados Excel",
                    ok: "Los interesados se han exportado correctamente",
                },
                impDocMass: {
                    label: "Importa documentos a los exp. seleccionados...",
            ...
            action: {
                ...
                notificar: {
                    ...
                    alert: {
                        ...
                        format: {
                            document: "El formato del documento actual es: .{{extension}}",
                            noSir: "Canal No-SIR: Los formatos admitidos son pdf y zip.",
                            sir: "Canal SIR: Los formatos admitidos son jpg, jpeg, odt, odp, ods, odg, docx, xlsx, pptx, pdf, png, rtf, svg, tiff, txt, xml y xsig.",
                        },
                    },
                },
                notificarMasiva: {
                    label: "Notifica o comunica...",
                    ok: "Se ha generado el documento con los elementos seleccionados",
                    error: {
                        noFirmats: "No se pueden notificar documentos sin firmar: {{noms}}",
                    },
                    tipusDoc: {
                        title: "Tipo del documento a notificar",
                        description: "Elija el tipo de documento que se aplicará al documento generado con los documentos seleccionados.",
                        button: "Genera",
                    },
                    ordre: {
        ...
        dada: {
            ...
            action: {
                new: {
                    label: "Añade valor para el dato",
        ...
        notificacioInteressat: {
            ...
            detall: {
                ...
                datat: "Datado",
                certificacio: "Justificante de recepción",
                ...
                enviamentDatatEstat: {
                    ...
                    ENTREGADA_OP: "Entregado al Operador Postal",
                    ENVIADA: "Enviada",
                    ENVIADA_AMB_ERRORS: "Enviada con errores",
                    ENVIADA_CI: "Enviado al centro de impresión",
                    ...
                    PENDENT_ENVIAMENT: "Pendiente de envío",
                ...
                registreEstat: "Estado de registro",
            },
            action: {
                ampliarPlac: {
                    label: "Amplia plazo...",
                ...
                certificat: {
                    label: "Justificante de recepción",
                    ok: "El justificante de recepción se ha descargado correctamente",
                },
            },
        },
        publicacio: {
        ...
        organGestor: {
            ...
            action: {
                ...
                actualitzar: {
                    ...
                    label: "Actualiza órganos gestores de DIR3",
        ...
        metaExpedient: {
            ...
            action: {
                ...
                importRolsac: {
                    label: "Importa desde ROLSAC...",
                    title: "Importar procedimiento desde ROLSAC",
                },
                importFitxer: {
                    label: "Importa desde fichero...",
        ...
        metaDocument: {
            ...
            reservat: "Los documentos reservados NOTIB_JUSTIFICANT_RECEPCIO, REGISTRE_JUSTIFICANT_ENTRADA, NOTIFICACIO_MULTIPLE y OTROS solo pueden ser editados por un administrador.",
            tabs: {
                dades: "Datos",
                nti: "Datos NTI",
        ...
        propietats: {
            ...
            action: {
                sync: {
                    label: "Sincroniza con JBoss",
                    ok: "Las propiedades se han sincronizado correctamente",
                },
                new: {
                    label: "Añade conf. específica",
        ...
        user: {
            ...
            action: {
                massives: {
                    label: "Consulta acciones masivas",
