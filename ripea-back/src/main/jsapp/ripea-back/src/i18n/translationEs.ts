const translationEs = {
    ...
    page: {
        ...
        metaDocument: {
            ...
            reservat: "Los documentos reservados NOTIB_JUSTIFICANT_RECEPCIO, REGISTRE_JUSTIFICANT_ENTRADA y NOTIFICACIO_MULTIPLE solo pueden ser editados por un administrador.",
            tabs: {
                dades: "Datos",
                nti: "Datos NTI",
