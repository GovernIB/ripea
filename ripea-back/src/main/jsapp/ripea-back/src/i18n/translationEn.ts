    ...
    page: {
        ...
        tasca: {
            ...
            kanban: {
                ...
                changeEstat: {
                    motiu: "Status change from kanban view",
                },
            },
            detall: {
                title: "Task details",
        ...
        expedient: {
            ...
            alert: {
                ...
                documentsFaltants: "This case file is missing some mandatory document types. As an administrator you can still close it by providing the reason for closing. The missing document types are:",
        ...
        notificacioInteressat: {
            ...
            detall: {
                ...
                enviamentDatatEstat: {
                    title: "Status",
                    ABSENT: "Absent",
                    ADRESA_INCORRECTA: "Incorrect address",
                    ANULADA: "Incorrect or erroneous notification",
                    DESCONEGUT: "Unknown",
                    ENTREGADA_OP: "Delivered to the Postal Operator",
                    ENVIADA: "Sent",
                    ENVIADA_AMB_ERRORS: "Sent with errors",
                    ENVIADA_CI: "Sent to the printing center",
                    ENVIADA_DEH: "Sent to the DEH (Delivery Office)",
                    ENVIAMENT_PROGRAMAT: "Scheduled shipment",
                    ENVIAT_SIR: "Sent SIR",
                    ERROR_ENTREGA: "Error in shipment",
                    EXPIRADA: "Expired",
                    EXTRAVIADA: "Lost",
                    FINALITZADA: "Finished",
                    FINALITZADA_AMB_ERRORS: "Finished with errors",
                    LLEGIDA: "Read",
                    MORT: "Deceased",
                    NOTIB_ENVIADA: "Sent",
                    NOTIB_PENDENT: "Pending send",
                    NOTIFICADA: "Notified",
                    PENDENT: "Pending",
                    PENDENT_CIE: "Pending delivery to CIE",
                    PENDENT_DEH: "Pending delivery to DEH",
                    PENDENT_ENVIAMENT: "Pending shipment",
                    PENDENT_SEU: "Pending Appearance",
                    PROCESSADA: "Processed",
                    REBUTJADA: "Refused",
                    REGISTRADA: "Registered",
                    SENSE_INFORMACIO: "No information",
                },
            ...
            action: {
                ...
                certificat: {
                    label: "Delivery receipt",
                    ok: "The delivery receipt has been downloaded successfully",
                },
            },
        },
        publicacio: {
        ...
        metaDocument: {
            ...
            reservat: "The reserved document types NOTIB_JUSTIFICANT_RECEPCIO, REGISTRE_JUSTIFICANT_ENTRADA, NOTIFICACIO_MULTIPLE and OTROS can only be edited by an administrator.",
            tabs: {
                dades: "Data",
                nti: "NTI data",
