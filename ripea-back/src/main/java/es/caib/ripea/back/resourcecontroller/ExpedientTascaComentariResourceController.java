 ...
 */
@RestController
@RequestMapping(BaseConfig.API_PATH + "/expedientTascaComentaris")
@Tag(name = "Comentaris", description = "Servei de gestió de comentaris")
public class ExpedientTascaComentariResourceController extends BaseMutableResourceController<ExpedientTascaComentariResource, Long> {
