 ...
 */
@RestController
@RequestMapping(BaseConfig.API_PATH + "/carpeta")
@Tag(name = "Carpetes", description = "Servei de gestió de carpeta")
public class CarpetaResourceController extends BaseMutableResourceController<CarpetaResource, Long> {
