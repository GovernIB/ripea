...
import es.caib.ripea.back.command.MetaExpedientRevisioCommand;
...
//		}
	...
	public String save(
		...
		MetaExpedientDto metaExpedientDto = metaExpedientRevisioService.canviarEstatRevisioASellecionat(
				entitatActual.getId(),
				dto,
