            ...
            <div class="btn-group navbar-btn navbar-right" style="margin-top: 25px;">
                <c:choose>
                    ...
                    <c:when test="${isRolActualAdministrador}">
                        <%---- Expedients ----%>
                        <a href="<c:url value="/ripeaback/expedient"></c:url>" class="btn btn-default"><span class="fa fa-folder" style="color: #004b99;"></span> <spring:message code="decorator.menu.expedients.new"/></a>
