...
<body>
	...
	<tbody>
		<c:choose>
			<c:when test="${errorObject.errorClassName == 'java.lang.SecurityException'}">
			...
			<c:when test="${errorObject.errorClassName == 'es.caib.ripea.core.api.exception.NotFoundException'}">
				<tr>
					<td width="20%"><strong><spring:message code="error.tipus.element"/></strong></td>
					<td>${errorObject.errorClassName}</td>
				</tr>
				<tr>
			...
			<c:when test="${errorObject.errorClassName == 'es.caib.ripea.core.api.exception.SistemaExternException'}">
				<tr>
		...
		<tr>
			<c:if test="${errorObject.errorClassName != 'java.lang.SecurityException'}">
				<td>
					<strong>
