...
<c:set var="titol"><spring:message code="expedient.tasca.reobrir.titol"/></c:set>
...
<body>
	<form:form action="" method="post" cssClass="form-horizontal" modelAttribute="tascaReobrirCommand">
		...
		<rip:inputSuggest 
			...
			textKey="expedient.tasca.reobrir.camp.responsable"
			suggestValue="codi"
			suggestText="codiAndNom"
			required="true"
			multiple="true"/>
		<rip:inputTextarea name="motiu" textKey="expedient.tasca.reobrir.camp.comentari"/>
		<div class="row" style="margin-bottom: 60px;"></div>
		
		<div id="modal-botons">
			<button type="submit" class="btn btn-success"><span class="fa fa-save"></span> <spring:message code="comu.boto.reobrir"/></button>
