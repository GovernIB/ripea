...
<form:form id="filtreForm" action="${ formAction }" method="post" cssClass="well defaultFilterEnter" modelAttribute="usuariTascaFiltreCommand">
    <div class="row">
        <div class="col-md-3">
            <rip:inputSelect
                    ...
                    <span class="usuariActualObservador"></span>
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="<c:url value="/expedientTasca/{{:id}}/detall"/>" data-maximized="false" data-toggle="modal">
									<span class="fa fa-info"></span>&nbsp;&nbsp;<spring:message code="comu.boto.detalls"/></a>
								</li>
							</ul>
						</div>
				{{else}}
