...
<c:set var="titol"><spring:message code="expedient.tasca.delegar.titol"/></c:set>
...
<body>
	<form:form action="" method="post" cssClass="form-horizontal" modelAttribute="tascaDelegarCommand">
		...
		<rip:inputSuggest 
			...
			textKey="expedient.tasca.delegar.camp.delegat"
			suggestValue="codi"
