...
<c:set var="titol"><spring:message code="expedient.tasca.reassignar.titol"/></c:set>
...
<body>
	<form:form action="" method="post" cssClass="form-horizontal" modelAttribute="tascaReassignarCommand">
