...
<body>
	<form:form id="expedientPeticioFiltreForm" action="" method="post" cssClass="well" commandName="expedientPeticioFiltreCommand">
		...
		<!--  optionMinimumResultsForSearch -->		
			<div class="col-md-4">					
				<rip:inputSelect name="metaExpedientId" optionItems="${metaExpedients}" optionMinimumResultsForSearch="1" optionValueAttribute="id" emptyOption="true" optionTextAttribute="nomICodiSia" placeholderKey="expedient.peticio.list.placeholder.metaExpedient" inline="true"/>
			</div>
<%--
			<div class="col-md-4">					
						...
						<div class="dropdown">
							...
							<ul class="dropdown-menu">
								...
								{{if estatView == 'PENDENT' && !pendentEnviarDistribucio}}
									...
									<li><a href="<c:url value="/expedientPeticio/rebutjar/{{:id}}"/>" data-toggle="modal" data-maximized="false"><span class="fa fa-times"></span>&nbsp;<spring:message code="comu.boto.rebutjar"/></a></li>
